...
function blockSaveBatton(popupEl) {
...
function initialDataImgPopup(name, link) {
...
buttonOpenEditProfilePopup.addEventListener('click', () => {
  initialDataEditPopup();
  openPopup(popupEditProfile);
  blockSaveBatton(popupEditProfile);
});
